...
bool Transform::sceneEventFilter(QGraphicsItem *watched, QEvent *event) {
    if (this->isAncestorOf(watched)) {
        ...
        case QEvent::GraphicsSceneMousePress:{
            ...
            // Copied from https://github.com/qt/qtbase/blob/625cfb6b400a88b26b7295f21699c9db28b71483/src/widgets/graphicsview/qgraphicsitem.cpp#L1092-L1101
            ...
            for (int i = 0x1; i <= 0x10; i <<= 1) {
                if (mouseEvent->buttons() & i) {
                    ...
                    mouseEvent->setButtonDownPos(button, this->mapFromItem(watched, mouseEvent->buttonDownPos(button)));
                }
            }
